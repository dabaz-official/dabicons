export default function Samples () {
  return (
    <section id="get-samples" aria-label="Free preview" className="scroll-mt-14 bg-blue-600 sm:scroll-mt-32">
      <div className="overflow-hidden lg:relative">
        <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:max-w-5xl lg:px-8 relative grid grid-cols-1 items-end gap-y-12 py-20 lg:static lg:grid-cols-2 lg:py-28 xl:py-32">
          <svg aria-hidden="true" width="432" height="184" className="absolute -top-32 left-0 w-full sm:left-3/4 sm:-top-5 sm:ml-8 sm:w-auto md:left-2/3 lg:left-auto lg:right-2 lg:ml-0 xl:right-auto xl:left-2/3">
            <defs>
          ...
          <div>
            ...
            <p className="mt-4 text-lg tracking-tight text-blue-200 text">
              Enter your email address and I’ll send you some samples from all the icons.
            </p>
          </div>
          <form className="lg:pl-16 text">
            <h3 className="text-base font-medium tracking-tight text-white">
              Get some samples straight to your inbox
